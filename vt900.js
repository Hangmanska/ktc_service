...
var ipmdev = new db.im2(db.get_configdb_dev());
...
function remove_from_web(req, res)
{
    var modem_id = req.body.modem_id;
  //  var db_name = req.body.db_name;
 // console.log(modem_id)

    var sql1="DELETE FROM setup_vehicle WHERE modem_id='"+modem_id+"'; DELETE FROM master_config_vehicle WHERE modem_id='"+modem_id+"'; DELETE FROM realtime WHERE modem_id='"+modem_id+"'; ";

  //  var sql2="DELETE FROM master_config_vehicle WHERE modem_id='"+modem_id+"' ";

  //  var sql3="DELETE FROM realtime WHERE modem_id='"+modem_id+"' ";
   ...
   // var x1 =false;var x2=false;var x3=false;
    ...
    excute(sql1,db_config,function(xres1)
    {
        if(xres1)
        {
            res.send('Delete From Web OK');
         //   x1=true;
           // finalx();
        }else{
          //  x1=false;
          //  finalx();
          res.send('Problem Del From Web !!!');
        }
    })
...
function check_can_forklift(req, res)
{
    var b =  req.body;
    console.log(b);
  var modem_id =  req.body.modem_id; //"142190463238";//

  var sql=" SELECT data_json,to_char(datetime,'YYYY-MM-DD HH24:MI') as datetime FROM tb_vt900_"+modem_id+" ORDER BY datetime DESC LIMIT 10";

console.log(sql);
  ipmdev.db.dbname = 'gps_vt900';
  db.get_rows(ipmdev, sql, function (rows) 
  {
...
exports.remove_from_web = remove_from_web;
...
exports.check_can_forklift  = check_can_forklift;
