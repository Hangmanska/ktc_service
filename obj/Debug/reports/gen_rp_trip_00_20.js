...
function get_data(para, callback)
{
  ...
  //  var end_date = date_process + ' 23:59';
    ...
    sql += " AND satelites >'0' AND message_id in('11','193')  ORDER BY gps_datetime ASC ";
        ...
        if (rows.length > 0)
        {
            ...
            }, function ()
            {
               // debugger;
                ...
                .Where(function (x) { return parseInt(x.distance) > 0 })
                .ToArray();
...
function start(date_gen_report) {
    ...
    // var date_gen_report = '2016-07-02';
    var sql = "SELECT modem_id,db_name,speedmax,track_every,oil_level  FROM master_config_vehicle  ORDER BY modem_id";
