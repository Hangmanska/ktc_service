...
//not include db_10036 = italthai
//not include db_10039 = nissan forklift
function start(date_gen_report) 
{
    //AND modem_id='1010005002' 
      ...
      //  var sql = "SELECT modem_id,db_name,speedmax,track_every  FROM master_config_vehicle WHERE  modem_id like '%14218%'   ORDER BY db_name";
        ...
        var sql = "SELECT modem_id,db_name,speedmax,track_every  FROM master_config_vehicle WHERE modem_id LIKE '%14%' AND db_name LIKE '%db_1%' ";
        sql = " AND db_name NOT IN ('db_10036','db_10039')  ORDER BY db_name DESC";
...
console.log('genreport restart  timenow : ' + irp.timenow());
