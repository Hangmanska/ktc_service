...
//step start report from insert_vehicle_lost 
function start_out_of_service(blackbox_id, vehicle_type, start_lost,id_lost,callback)
{
...
function set_recnow_outofservice(data, callback)
{
    ...
    if (data.r_status == '88')//รถตัด
    {
        ...
        dtc2cane.get_harvester_code(data.blackbox_id, function (harvester_code)
        {
            var xres = harvester_code+','+data.r_time + ',' + "OUT_OF_SERVICE";
            dtc2cane.set_harvest_vehicle_working_current(xres, function (tres) {
...
function set_havester_or_truck(blackbox_id,vehicle_type,callback)
{
   // vehicle_type = vehicle_type == "harvester" ? "0" : "1";
    ...
    {
        dtc2cane.get_harvester_code(blackbox_id, function (harvester_code)
        {
    ...
    {
        dtc2cane.get_truck_code(blackbox_id, function (truck_code)
        {
