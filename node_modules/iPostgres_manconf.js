...
exports.iNonQuery_cb = function (dbname, sql, callback) {
...
function _iexcute_cb(ipg_man, para, callback) {
    ipg_man.iNonQuery_cb(para.config_con, para.sql, function (is_ok) {
        callback(is_ok);
        return;
    });
}
...
exports._iexcute_cb = _iexcute_cb;
