...
var result = { 'blackbox_id': '', 'plot_code': '', 'r_time': '', 'htt_id_lost': '','name':' ' }
...
function has_harvester_truck(backbox_id_havester, lon, lat, meter_radius, callback)
{
    ...
    sql += " , " + meter_radius + ")  "
    sql += " AND htt_harvester_or_truck ='1' LIMIT 1 ";  //htt_havester ='1' this mean truck
   // sql += " LIMIT 1 ";
   ...
   debugger;
    db.get_rows(pg_realtime, sql, function (res) {
       ...
       if (res.length > 0)
       {
            ...
            dtc2cane.get_truck_code(result.blackbox_id, function (truck_name) {
                debugger;
