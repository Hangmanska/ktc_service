...
/*
            ...
            */
            ...
            if(para.dlt_model_id ===undefined)
            {
                para.dlt_model_id = '1210002';
            }
            ...
            else if(utl.Contains(para.chassis_no,'-'))
            {
                ...
                query +=",dlt_model_id='"+para.dlt_model_id+"' ";  //U1 lite plus '1210001' -- VT900 '1210002'
...
function send_dltnow(req,res)
{
    var b = req.body;
  

   var sql= "UPDATE realtime SET send_dlt_now='"+b.on_off+"' WHERE modem_id='"+b.modem_id+"' ";
...
exports.send_dltnow = send_dltnow;
