...
var rule_6040 = new schedule.RecurrenceRule();
rule_6040.dayOfWeek = [new schedule.Range(0, 6)];
rule_6040.hour = 04;
rule_6040.minute = 35;
...
var rule_6042 = new schedule.RecurrenceRule();
rule_6042.dayOfWeek = [new schedule.Range(0, 6)];
rule_6042.hour = 05;
rule_6042.minute = 00;
...
var port_6033 ='iServer_6033_VT900_Center';//center vt900
var port_6040 ='iServer_6040_VT900_Center2';//center2 vt900

var port_6034 ='iServer_6034_VT900_Nao';
var port_6036 ='iServer_6036_VT900_Italthai';
var port_6039 ='iServer_6039_VT900_Nissan';
var port_6042 ='iServer_6042_LPT'; //ลำลูกกาขนส่ง
...
schedule.scheduleJob(rule_6040, function () 
{
  console.log('restart iServer_6040 '+moment().format("YYYY-MM-DD HH:mm"));
  restart_6040();
});
...
schedule.scheduleJob(rule_6042, function () {
 

  //var date_gen_report = moment().format("YYYY-MM-DD");
 // var date_gen_report = moment().subtract(1, "days").format("YYYY-MM-DD");

  console.log('restart iServer_6042_LPT '+moment().format("YYYY-MM-DD HH:mm"));
...
function restart_6040()
{
  ...
  pm2.connect(function(err) {
    ...
    setTimeout(function worker() {
      console.log("Restarting app...");
      pm2.restart(port_6040, function() {});
        setTimeout(worker, 1000);
      }, 1000);
  });
...
function restart_lpt_6042()
{
  ...
  pm2.connect(function(err) {
    ...
    setTimeout(function worker() {
      console.log("Restarting app...");
      pm2.restart(port_6042, function() {});
        setTimeout(worker, 1000);
      }, 1000);
  });
...
function restart_backend_real()
{
  ...
  pm2.connect(function(err) {
    ...
    setTimeout(function worker() {
      console.log("Restarting app...");
      pm2.restart('backend_real', function() {});
        setTimeout(worker, 1000);
      }, 1000);
  });
...
schedule.scheduleJob('1 * * * *', function() { //run every hour at minute 1
  ...
  restart_center_6033();
  restart_backend_real();
});


schedule.scheduleJob('5 * * * *', function() { //run every hour at minute 5
  //console.log('The answer to life, the universe, and everything!');
  console.log('restart iServer_6033_VT900_Center '+moment().format("YYYY-MM-DD HH:mm"));
  restart_center_6033();
});
