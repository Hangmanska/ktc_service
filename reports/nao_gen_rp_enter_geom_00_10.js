  ...
  FROM x 
   ...
   var sql=''
    ...
    if(para.nao_group_sale !='X')
    {
        ...
        sql+=" ,fn_nao_prfix_zone_id2(geom_id::varchar) as id_zone,enter_time  "
        ...
        sql+="    ) "
        sql+="    SELECT string_agg (fn_nao_zone_name(fn_nao_prfix_zone_id2(geom_id::varchar)) ||''||geom_name, ',')as geom_name  "
        sql+="    FROM x "
    }
    else
    {
