...
function get_data(para,callback)
{
    ...
    sql += ",idate(gps_datetime::TIMESTAMP) as gps_datetime,CASE  WHEN CAST(analog_input2 as int)=2400 THEN '3' WHEN CAST(analog_input2 as int)=2402 THEN '2' ELSE status END as input_status,lon||','||lat as lonlat ,lon,lat";
    sql += ",tambol||':'||amphur||':'||province as locations_th,etambol||':'||eamphur||':'||eprovince as locations_en ";
    sql +=",mileage,CASE  WHEN CAST(analog_input2 as int)=2400 THEN '3' WHEN CAST(analog_input2 as int)=2402 THEN '2' ELSE status END as status,modem_id"
...
/*
var para = { 'id': 1, 'db_name': 'db_10036', 'modem_id': '142190463056', 'start_time':'2020-01-27 00:00' , 'end_time': '2020-01-27 23:59' , 'message': '' }
