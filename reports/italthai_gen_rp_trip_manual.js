...
function start(date_gen_report) 
{
    //AND modem_id='1010005002' 
      ...
      //  var sql = "SELECT modem_id,db_name,speedmax,track_every  FROM master_config_vehicle WHERE  modem_id like '%14218%'   ORDER BY db_name";
        ...
        //WHERE db_name='db_10034' WHERE db_name='db_10034' WHERE db_name='db_10034'  AND modem_id='143190871335' 
        var sql = "SELECT modem_id,db_name,speedmax,track_every  FROM master_config_vehicle WHERE db_name='db_10036'  AND modem_id='143200384772'   ORDER BY db_name DESC";
