...
function _start(date_gen_report) 
{
    //AND modem_id='1010005002' 
      ...
      //  var sql = "SELECT modem_id,db_name,speedmax,track_every  FROM master_config_vehicle WHERE  modem_id like '%14218%'   ORDER BY db_name";
        ...
        var sql = "SELECT modem_id,db_name,speedmax,track_every  FROM master_config_vehicle  WHERE modem_id IN('142190463174','142190463065','142190463154','142190463221','142190463157','142190463189','143190871649','142190463250') ORDER BY db_name DESC";
...
, 'start_time': '2021-07-01 00:00', 'end_time': '2021-07-31 23:59', 'date_gen_report': '2021-06-28', 'message': '' }
