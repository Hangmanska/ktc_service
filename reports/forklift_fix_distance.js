...
sql+=" WHERE gps_datetime>='2021-10-20 00:00' ";
sql+=" AND gps_datetime <='2021-10-31 23:59'  ";
...
function fix_mileage()
{
   ...
   sql+="  AND mcv.db_name='db_10039'  AND r.modem_id ='143190871333' ";
   /*
