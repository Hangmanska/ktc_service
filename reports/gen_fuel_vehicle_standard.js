...
function get_all_vehicle_calculate_fuel(start_date)
{
  ...
  // var sql = "SELECT modem_id,harvester_name,'"+date_process+"' as date_process FROM harvester_register2";ORDER BY db_name is_calculate_fuel='1'  AND  modem_id='1010006003' AND db_name='db_10003' modem_id='1010006001' AND
   //var sql= "SELECT modem_id,db_name FROM master_config_vehicle WHERE is_calculate_fuel='1'  AND db_name !='db_10003'   ORDER BY db_name ; ";AND  modem_id='142190463048'
   var sql= "SELECT modem_id,db_name FROM master_config_vehicle WHERE is_calculate_fuel='1' AND install_fuel_utrasonic IS NULL   AND db_name !='db_10003'  ORDER BY modem_id ; ";
   ipm.db.dbname = db_config;
...
setTimeout(function () {
    ...
    var xdate =  '2020-09-22';//req.body.start; //2018-11-17'
