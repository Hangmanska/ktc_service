...
function new_utilization_vehicle(req, res)
{
    ...
    var start = req.body.start; // '2016-09';//
    var stop = req.body.stop; //'2016-09-09 23:59';//
    console.log("backend_report_chart >> new_utilization_vehicle "+db_name+' '+modem_id+' '+start+' '+stop)
   /*
...
{
    var db_name = 'db_10039'; //req.body.fleetid; //
    var modem_id = '143190871464';// req.body.modemid; //
    var start = '2021-10-15 00:00';// req.body.start; // 
    var stop = '2021-10-15 23:59';//req.body.stop; //
