...
function get_data(para,callback) 
{
    ...
    {
        var sql = ' ';
        sql += " SELECT idate(gps_datetime) as gps_datetime,lon||','||lat as lonlat,CAST(speed as int) as speed,mileage,tambol||':'||amphur||':'||province as locations_th,etambol||':'||eamphur||':'||eprovince as locations_en ";
