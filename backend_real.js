...
//var upload = require('./upload_all_local_test.js');
...
apiRoutes.post('/find_near_me', kpwp.find_near_me);
apiRoutes.post('/find_farm_near_me', kpwp.find_farm_near_me);
apiRoutes.post('/report_harvester_working_on_farm', kpwp.report_harvester_working_on_farm);
...
apiRoutes.post('/get_data_realtime_ksp', kpwp.get_data_realtime_ksp);
apiRoutes.post('/get_report_activity_farm', kpwp.get_report_activity_farm);
apiRoutes.post('/get_report_graph_harvester_cutting', kpwp.get_report_graph_harvester_cutting);
...
apiRoutes.post('/check_can_forklift', vt900.check_can_forklift);
...
apiRoutes.post('/remove_from_web', vt900.remove_from_web);
...
apiRoutes.post('/tracking_realtime_italthai', ital.tracking_realtime_italthai);
...
apiRoutes.post('/set_note_italthai', ital.set_note_italthai);

apiRoutes.post('/get_report_note_italthai', ital.get_report_note_italthai);
apiRoutes.post('/get_report_usage_vehicle_italthai', ital.get_report_usage_vehicle_italthai);
apiRoutes.post('/get_report_inout_geom_italthai', ital.get_report_inout_geom_italthai);
apiRoutes.post('/get_report_parking_italthai', ital.get_report_parking_italthai);
apiRoutes.post('/get_report_idling_italthai', ital.get_report_idling_italthai);

apiRoutes.post('/maintanace_italthai', ital.maintanace_italthai);
apiRoutes.post('/set_hour_start_service', ital.set_hour_start_service);
...
apiRoutes.post('/tracking_forklift', function (req, res) 
{
 ...
 // console.log(req.body);
   ...
   if(req.body.modem_id =="143190871737")
   {
...
apiRoutes.post('/report_summary_forklift_monthly', nissan.report_summary_forklift_monthly);
...
apiRoutes.post('/rp_rfid_working_details', nissan.rp_rfid_working_details);
apiRoutes.post('/get_noti_details_forklift', nissan.get_noti_details_forklift);
apiRoutes.post('/rp_rfid_working_summary', nissan.rp_rfid_working_summary);
apiRoutes.post('/rp_usage_vehicle_forklift', nissan.rp_usage_vehicle_forklift);
apiRoutes.post('/rp_usage_vehicle_forklift_monthly', nissan.rp_usage_vehicle_forklift_monthly);
apiRoutes.post('/rp_usage_vehicle_and_driver', nissan.rp_usage_vehicle_and_driver);
