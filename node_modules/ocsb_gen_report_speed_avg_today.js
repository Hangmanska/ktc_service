...
function process_report_avg_speed_today(date_process,callback)
{
...
function clear_report_today(iTODAY,callback)
{
    var sql =" DELETE  FROM harvester_avg_speed_report WHERE date_process >="+utl.sqote(iTODAY)+" AND date_process <="+utl.sqote(iTODAY);
...
setTimeout(function () {
   ...
   var start_date = '2018-03-22';//date_now.format('YYYY-MM-DD') 

   process_report_avg_speed_today(start_date,function(xre){
       console.log(xre);
   });
 }, 1000);
  */

exports.process_report_avg_speed_today = process_report_avg_speed_today;
exports.clear_report_today = clear_report_today;