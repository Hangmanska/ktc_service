...
function get_realtime_dashboard(req, res)
{
  ...
  //  req.params.modem_id ;
   ...
   // var r = { modem_id:'1010001001'}
    ...
    if(object.db_name!='db_10000')
    {  
        sql2 = "SELECT * FROM realtime";
        ipm.db.dbname = db_name_sensor;
    }
    else
    {
         sql2 = "SELECT * FROM sensor_realtime";
        ipm.db.dbname = db_config;
    }
...
function add_sensor_iso(req, res)
{
    //
    var object = { "db_name": 'db_10001', 'fleetname':'demo1' };

    object.db_name = object.db_name+'_sensor';

    var r = {
        modem_id: "1010001001",
        modem_name: "demo_temp2",
        ondelay_sec: 120,
        start_time: "2017-07-07 11:43:25",
        total_time: 7,
        iso4: {
    ...
    .set("analog2", JSON.stringify(r.analog2))
     .set("analog3", JSON.stringify(r.analog3))
    .set("analog4", JSON.stringify(r.analog4))
     .set("iso_resistant", r.iso_resistant)
     .set("status", r.status)
    // .where("modem_id='"+r.modem_id+"'")
     .toString();
 ...
 //  req.params.modem_id ;
  ...
  console.log(object)
   ...
   db.get_rows(ipm, sql, function (data_sensor) 
   {
       ...
       console.log(data_sensor.length);
       if(data_sensor.length > 0)
       {
